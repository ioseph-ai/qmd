 ...
 * Works with any LLM implementation. For LlamaCpp specifically, coordinates
 * with its idle timeout to prevent disposal during active sessions.
 */
 ...
 * Works with any LLM implementation (LlamaCpp, RemoteLLM, etc.).
 */
